...
const ENT_SUPABASE_IMAGE_URL =
  'https://hjluqxfmvpvtjvwzqxgi.supabase.co/storage/v1/object/public/files/static/specialities/ent.png';

export class EntSpeciality1778670000000 implements MigrationInterface {
  name = 'EntSpeciality1778670000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    const bundled = SPECIALITY_IMAGES[SPEC.name_en];
    const imageUrl = ENT_SUPABASE_IMAGE_URL || bundled;
    if (!imageUrl) {
